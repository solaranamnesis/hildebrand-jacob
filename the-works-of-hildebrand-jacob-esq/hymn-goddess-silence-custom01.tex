...
\usepackage[top=28mm, bottom=37mm, outer=20mm, inner=110mm, landscape]{geometry}
\setlength{\columnsep}{70pt}
\definecolor{customColor}{RGB}{252,234,245}
\color{White}
\AddToShipoutPictureBG{\includegraphics[width=\paperwidth,height=\paperheight]{angerona.jpeg}}
...
\allsectionsfont{\LARGE\Fontauri\bfseries}
\sectionfont{\LARGE\Fontauri\bfseries}
\subsectionfont{\Fontauri\bfseries}
\subsubsectionfont{\Fontauri\bfseries}
...
\begin{titlepage} % Suppresses headers and footers on the title page
	...
	{\scshape\Huge Hymn to the \\ Goddess of Silence}
	...
	{\scshape \large By \LARGE Hildebrand Jacob, \emph{Esq.}} % Subtitle or further description
...
\vspace*{\fill}
	...
	{\normalsize\scshape Printed for J. Watts at the Printing-Office in \emph{Wild-Court} near \emph{Lincoln's-Inn Fields}.}
...
% Publication year
	...
	{\scshape\small Attribution - Partage dans les mêmes conditions 4.0 International} % Publisher
\end{titlepage}
